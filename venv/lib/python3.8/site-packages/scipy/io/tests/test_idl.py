...
class TestCompressed(TestScalars):
    ...
    def test_compressed(self):
        ...
        assert_identical(s.arrays.dictNextDay[0], np.array([b"cheese", b"bacon", b"spam"], dtype=object))
...
class TestStructures:
    ...
    def test_scalars(self):
        ...
        assert_identical(s.scalars.dictNextDay, np.array(np.float64(4.)))
    ...
    def test_scalars_replicated(self):
        ...
        assert_identical(s.scalars_rep.dictNextDay, np.repeat(np.float64(4.), 5))
    ...
    def test_scalars_replicated_3d(self):
        ...
        assert_identical(s.scalars_rep.dictNextDay, np.repeat(np.float64(4.), 24).reshape(4, 3, 2))
    ...
    def test_arrays(self):
        ...
        assert_array_identical(s.arrays.dictNextDay[0], np.array([b"cheese", b"bacon", b"spam"], dtype=object))
        ...
        for i in range(5):
            ...
            assert_array_identical(s.arrays_rep.c[i],
                                   np.array([np.complex64(1+2j),
                                             np.complex64(7+8j)]))
            assert_array_identical(s.arrays_rep.dictNextDay[i],
    ...
    def test_arrays_replicated_3d(self):
        ...
        assert_equal(s.arrays_rep.dictNextDay.shape, (4, 3, 2))
            ...
            for j in range(3):
                for k in range(2):
                    ...
                    assert_array_identical(s.arrays_rep.c[i, j, k],
                                           np.array([np.complex64(1+2j),
                                                     np.complex64(7+8j)]))
                    assert_array_identical(s.arrays_rep.dictNextDay[i, j, k],
                                           np.array([b"cheese", b"bacon", b"spam"],
                                                    dtype=object))
